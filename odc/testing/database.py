...
def auto_odc_db(odc_test_db, request):
    ...
    `METADATA_TYPES`, `PRODUCTS`, and `DATASETS`, which should be a list of
    filenames relative to the test module. These files will be added to the
    current ODC DB, defined by environment variables in the `odc_test_db`
    fixture.
